...
const accountGet = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountCreate = async ({ userId, email, password, name, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} userId */
    /* @param {string} email */
...
const accountDelete = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountUpdateEmail = async ({ email, password, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} email */
    /* @param {string} password */
...
const accountCreateJWT = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountGetLogs = async ({ limit, offset, parseOutput = true, sdk = undefined, json }) => {
    /* @param {number} limit */
    /* @param {number} offset */
...
const accountUpdateName = async ({ name, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} name */
...
const accountUpdatePassword = async ({ password, oldPassword, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} password */
...
const accountGetPrefs = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountUpdatePrefs = async ({ prefs, parseOutput = true, sdk = undefined, json }) => {
    /* @param {object} prefs */
...
const accountCreateRecovery = async ({ email, url, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} email */
    /* @param {string} url */
...
const accountUpdateRecovery = async ({ userId, secret, password, passwordAgain, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} userId */
    /* @param {string} secret */
    /* @param {string} password */
...
const accountGetSessions = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountCreateSession = async ({ email, password, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} email */
    /* @param {string} password */
...
const accountDeleteSessions = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountCreateAnonymousSession = async ({ parseOutput = true, sdk = undefined, json }) => {
...
const accountCreateMagicURLSession = async ({ userId, email, url, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} userId */
    /* @param {string} email */
    /* @param {string} url */
...
const accountUpdateMagicURLSession = async ({ userId, secret, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} userId */
    /* @param {string} secret */
...
const accountCreateOAuth2Session = async ({ provider, success, failure, scopes, parseOutput = true, sdk = undefined, json }) => {
...
const accountGetSession = async ({ sessionId, parseOutput = true, sdk = undefined, json }) => {
...
const accountDeleteSession = async ({ sessionId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} sessionId */
...
const accountCreateVerification = async ({ url, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} url */
...
const accountUpdateVerification = async ({ userId, secret, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} userId */
    /* @param {string} secret */
...
account
    ...
    .requiredOption(`--provider <provider>`, `OAuth2 Provider. Currently, supported providers are: amazon, apple, bitbucket, bitly, box, discord, dropbox, facebook, github, gitlab, google, linkedin, microsoft, notion, paypal, paypalSandbox, salesforce, slack, spotify, tradeshift, tradeshiftBox, twitch, vk, yahoo, yammer, yandex, wordpress.`)
