...
users
    ...
    .option("--limit <limit>", "Maximum number of users to return in response. By default will return maximum 25 results. Maximum of 100 results allowed per request.")
...
users
    ...
    .requiredOption("--userId <userId>", "User ID.")
    .requiredOption("--status <status>", "User Status. To activate the user pass `true` and to block the user pass `false`.")
    .option('--json', 'Output in JSON format')
...
users
    ...
    .requiredOption("--userId <userId>", "User ID.")
    .requiredOption("--emailVerification <emailVerification>", "User email verification status.")
    .option('--json', 'Output in JSON format')
