...
const teamsList = async ({ search, limit, offset, cursor, cursorDirection, orderType, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} search */
    /* @param {number} limit */
    /* @param {number} offset */
    /* @param {string} cursor */
...
const teamsCreate = async ({ teamId, name, roles, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} name */
    /* @param {string[]} roles */
...
const teamsGet = async ({ teamId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
...
const teamsUpdate = async ({ teamId, name, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} name */
...
const teamsDelete = async ({ teamId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
...
const teamsGetMemberships = async ({ teamId, search, limit, offset, cursor, cursorDirection, orderType, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} search */
    /* @param {number} limit */
    /* @param {number} offset */
...
const teamsCreateMembership = async ({ teamId, email, roles, url, name, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} email */
    /* @param {string[]} roles */
    /* @param {string} url */
...
const teamsGetMembership = async ({ teamId, membershipId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
...
const teamsUpdateMembershipRoles = async ({ teamId, membershipId, roles, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} membershipId */
    /* @param {string[]} roles */
...
const teamsDeleteMembership = async ({ teamId, membershipId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} membershipId */
...
const teamsUpdateMembershipStatus = async ({ teamId, membershipId, userId, secret, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} teamId */
    /* @param {string} membershipId */
    /* @param {string} userId */
    /* @param {string} secret */
...
teams
    ...
    .option("--limit <limit>", "Maximum number of teams to return in response. By default will return maximum 25 results. Maximum of 100 results allowed per request.")
...
teams
    ...
    .requiredOption("--teamId <teamId>", "Team ID.")
    .option("--search <search>", "Search term to filter your list results. Max length: 256 chars.")
    .option("--limit <limit>", "Maximum number of memberships to return in response. By default will return maximum 25 results. Maximum of 100 results allowed per request.")
