...
const projectsList = async ({ search, limit, offset, cursor, cursorDirection, orderType, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} search */
    /* @param {number} limit */
    /* @param {number} offset */
    /* @param {string} cursor */
...
const projectsCreate = async ({ projectId, name, teamId, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, parseOutput = true, sdk = undefined, json }) => {
...
const projectsGet = async ({ projectId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsUpdate = async ({ projectId, name, description, logo, url, legalName, legalCountry, legalState, legalCity, legalAddress, legalTaxId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} name */
    /* @param {string} description */
    /* @param {string} logo */
...
const projectsDelete = async ({ projectId, password, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsUpdateAuthLimit = async ({ projectId, limit, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {number} limit */
...
const projectsUpdateAuthStatus = async ({ projectId, method, status, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} method */
...
const projectsListDomains = async ({ projectId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsCreateDomain = async ({ projectId, domain, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} domain */
...
const projectsGetDomain = async ({ projectId, domainId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsDeleteDomain = async ({ projectId, domainId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} domainId */
...
const projectsUpdateDomainVerification = async ({ projectId, domainId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} domainId */
...
const projectsListKeys = async ({ projectId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsCreateKey = async ({ projectId, name, scopes, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} name */
    /* @param {string[]} scopes */
...
const projectsGetKey = async ({ projectId, keyId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} keyId */
...
const projectsUpdateKey = async ({ projectId, keyId, name, scopes, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} keyId */
    /* @param {string} name */
    /* @param {string[]} scopes */
...
const projectsDeleteKey = async ({ projectId, keyId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} keyId */
...
const projectsUpdateOAuth2 = async ({ projectId, provider, appId, secret, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsListPlatforms = async ({ projectId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsCreatePlatform = async ({ projectId, type, name, key, store, hostname, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} type */
    /* @param {string} name */
    /* @param {string} key */
...
const projectsGetPlatform = async ({ projectId, platformId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsUpdatePlatform = async ({ projectId, platformId, name, key, store, hostname, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} platformId */
    /* @param {string} name */
    /* @param {string} key */
...
const projectsDeletePlatform = async ({ projectId, platformId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} platformId */
...
const projectsUpdateServiceStatus = async ({ projectId, service, status, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsGetUsage = async ({ projectId, range, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} range */
...
const projectsListWebhooks = async ({ projectId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsCreateWebhook = async ({ projectId, name, events, url, security, httpUser, httpPass, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} name */
    /* @param {string[]} events */
    /* @param {string} url */
...
const projectsGetWebhook = async ({ projectId, webhookId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
...
const projectsUpdateWebhook = async ({ projectId, webhookId, name, events, url, security, httpUser, httpPass, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} webhookId */
    /* @param {string} name */
    /* @param {string[]} events */
...
const projectsDeleteWebhook = async ({ projectId, webhookId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} projectId */
    /* @param {string} webhookId */
