...
const functionsCreateExecution = async ({ functionId, data, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
    /* @param {string} data */
...
const functionsUpdateTag = async ({ functionId, tag, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
    /* @param {string} tag */
...
const functionsListTags = async ({ functionId, search, limit, offset, cursor, cursorDirection, orderType, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
    /* @param {string} search */
    /* @param {number} limit */
    /* @param {number} offset */
...
const functionsCreateTag = async ({ functionId, command, code, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
...
const functionsGetTag = async ({ functionId, tagId, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
    /* @param {string} tagId */
...
const functionsDeleteTag = async ({ functionId, tagId, parseOutput = true, sdk = undefined}) => {
    /* @param {string} functionId */
    /* @param {string} tagId */
