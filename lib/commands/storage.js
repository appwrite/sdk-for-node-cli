...
const storageCreateFile = async ({ fileId, file, read, write, parseOutput = true, sdk = undefined, onProgress = () => {}}) => {
    /* @param {string} fileId */
    /* @param {File} file */
    /* @param {string[]} read */
    /* @param {string[]} write */
...
const storageGetFileDownload = async ({ fileId, parseOutput = true, sdk = undefined, destination}) => {
    /* @param {string} fileId */
...
const storageGetFilePreview = async ({ fileId, width, height, gravity, quality, borderWidth, borderColor, borderRadius, opacity, rotation, background, output, parseOutput = true, sdk = undefined, destination}) => {
    /* @param {string} fileId */
    /* @param {number} width */
    /* @param {number} height */
...
const storageGetFileView = async ({ fileId, parseOutput = true, sdk = undefined, destination}) => {
    /* @param {string} fileId */
