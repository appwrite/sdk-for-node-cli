...
const databaseListCollections = async ({ search, limit, offset, cursor, cursorDirection, orderType, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} search */
    /* @param {number} limit */
    /* @param {number} offset */
    /* @param {string} cursor */
...
const databaseCreateCollection = async ({ collectionId, name, permission, read, write, parseOutput = true, sdk = undefined, json }) => {
...
const databaseGetCollection = async ({ collectionId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseUpdateCollection = async ({ collectionId, name, permission, read, write, enabled, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} name */
    /* @param {string} permission */
    /* @param {string[]} read */
...
const databaseDeleteCollection = async ({ collectionId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseListAttributes = async ({ collectionId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseCreateBooleanAttribute = async ({ collectionId, key, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseCreateEmailAttribute = async ({ collectionId, key, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {boolean} required */
...
const databaseCreateEnumAttribute = async ({ collectionId, key, elements, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseCreateFloatAttribute = async ({ collectionId, key, required, min, max, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {boolean} required */
    /* @param {string} min */
...
const databaseCreateIntegerAttribute = async ({ collectionId, key, required, min, max, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {boolean} required */
    /* @param {number} min */
...
const databaseCreateIpAttribute = async ({ collectionId, key, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {boolean} required */
    /* @param {string} xdefault */
...
const databaseCreateStringAttribute = async ({ collectionId, key, size, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {number} size */
    /* @param {boolean} required */
...
const databaseCreateUrlAttribute = async ({ collectionId, key, required, xdefault, array, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {boolean} required */
    /* @param {string} xdefault */
...
const databaseGetAttribute = async ({ collectionId, key, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseDeleteAttribute = async ({ collectionId, key, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseListDocuments = async ({ collectionId, queries, limit, offset, cursor, cursorDirection, orderAttributes, orderTypes, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseCreateDocument = async ({ collectionId, documentId, data, read, write, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseGetDocument = async ({ collectionId, documentId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} documentId */
...
const databaseUpdateDocument = async ({ collectionId, documentId, data, read, write, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} documentId */
    /* @param {object} data */
    /* @param {string[]} read */
...
const databaseDeleteDocument = async ({ collectionId, documentId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} documentId */
...
const databaseListDocumentLogs = async ({ collectionId, documentId, limit, offset, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} documentId */
    /* @param {number} limit */
    /* @param {number} offset */
...
const databaseListIndexes = async ({ collectionId, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
...
const databaseCreateIndex = async ({ collectionId, key, type, attributes, orders, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
    /* @param {string} type */
...
const databaseGetIndex = async ({ collectionId, key, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseDeleteIndex = async ({ collectionId, key, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} key */
...
const databaseListCollectionLogs = async ({ collectionId, limit, offset, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {number} limit */
    /* @param {number} offset */
...
const databaseGetUsage = async ({ range, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} range */
...
const databaseGetCollectionUsage = async ({ collectionId, range, parseOutput = true, sdk = undefined, json }) => {
    /* @param {string} collectionId */
    /* @param {string} range */
...
database
    ...
    .option("--limit <limit>", "Maximum number of collection to return in response. By default will return maximum 25 results. Maximum of 100 results allowed per request.")
    .option("--offset <offset>", "Offset value. The default value is 0. Use this param to manage pagination. [learn more about pagination](https://appwrite.io/docs/pagination)")
...
database
    ...
    .option("--enabled <enabled>", "Is collection enabled?")
    .option('--json', 'Output in JSON format')
...
database
    ...
    .requiredOption("--required <required>", "Is attribute required?")
...
database
    ...
    .requiredOption("--collectionId <collectionId>", "Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/database#createCollection).")
    .requiredOption("--key <key>", "Attribute Key.")
    .requiredOption("--size <size>", "Attribute size for text attributes, in number of characters.")
    .requiredOption("--required <required>", "Is attribute required?")
    .option("--xdefault <xdefault>", "Default value for attribute when not provided. Cannot be set when attribute is required.")
    .option("--array <array>", "Is attribute an array?")
    .option('--json', 'Output in JSON format')
...
database
    ...
    .option("--limit <limit>", "Maximum number of documents to return in response. By default will return maximum 25 results. Maximum of 100 results allowed per request.")
