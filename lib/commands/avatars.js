...
const avatarsGetBrowser = async ({ code, width, height, quality, parseOutput = true, sdk = undefined}) => {
    /* @param {string} code */
    /* @param {number} width */
    /* @param {number} height */
...
const avatarsGetCreditCard = async ({ code, width, height, quality, parseOutput = true, sdk = undefined}) => {
    /* @param {string} code */
    /* @param {number} width */
    /* @param {number} height */
    /* @param {number} quality */
...
const avatarsGetFavicon = async ({ url, parseOutput = true, sdk = undefined}) => {
    /* @param {string} url */
...
const avatarsGetFlag = async ({ code, width, height, quality, parseOutput = true, sdk = undefined}) => {
    /* @param {string} code */
    /* @param {number} width */
    /* @param {number} height */
    /* @param {number} quality */
...
const avatarsGetImage = async ({ url, width, height, parseOutput = true, sdk = undefined}) => {
    /* @param {string} url */
    /* @param {number} width */
    /* @param {number} height */
...
const avatarsGetInitials = async ({ name, width, height, color, background, parseOutput = true, sdk = undefined}) => {
    /* @param {string} name */
    /* @param {number} width */
    /* @param {number} height */
    /* @param {string} color */
...
const avatarsGetQR = async ({ text, size, margin, download, parseOutput = true, sdk = undefined}) => {
    /* @param {string} text */
    /* @param {number} size */
    /* @param {number} margin */
...
avatars
    ...
    .option("--width <width>", "Image width. Pass an integer between 0 to 2000. Defaults to 100.")
    .option("--height <height>", "Image height. Pass an integer between 0 to 2000. Defaults to 100.")
    .option("--quality <quality>", "Image quality. Pass an integer between 0 to 100. Defaults to 100.")
...
avatars
    ...
    .option("--size <size>", "QR code size. Pass an integer between 0 to 1000. Defaults to 400.")
    .option("--margin <margin>", "Margin from edge. Pass an integer between 0 to 10. Defaults to 1.")
    .option("--download <download>", "Return resulting image with 'Content-Disposition: attachment ' headers for the browser to start downloading it. Pass 0 for no header, or 1 for otherwise. Default value is set to 0.")
